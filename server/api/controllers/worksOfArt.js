...
class WorksOfArt {
  constructor () {
    ...
    this.WorkOfArtModel = swaggerSequelize.sequelize.define('WorkOfArt', swaggerSequelize.swaggerSequelize.generate(swaggerSequelize.swaggerSpec.definitions.WorkOfArt))
    this.syncModel()
